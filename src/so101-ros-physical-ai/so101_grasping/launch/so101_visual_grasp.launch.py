...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("ik_pregrasp_settle_s", default_value="0.03"),
            DeclareLaunchArgument("ik_grasp_settle_s", default_value="0.02"),
            DeclareLaunchArgument("ik_retreat_settle_s", default_value="0.02"),
            ...
            DeclareLaunchArgument("post_grasp_return_vel_scaling", default_value="0.24"),
            DeclareLaunchArgument("post_grasp_return_acc_scaling", default_value="0.24"),
            ...
            DeclareLaunchArgument("post_grasp_use_ik_joints", default_value="true"),
            DeclareLaunchArgument("ik_joints_service_name", default_value="/go_to_joints"),
            DeclareLaunchArgument("ik_post_grasp_duration_s", default_value="1.2"),
