...
python3 /home/rog/ros2_ws/src/so101-ros-physical-ai/tools/handeye/collect_aruco_handeye_samples.py \
  ...
  --out /home/rog/ros2_ws/calibration/handeye/aruco_handeye_samples.json
```
...
python3 /home/rog/ros2_ws/src/so101-ros-physical-ai/tools/handeye/solve_aruco_handeye.py \
  --samples /home/rog/ros2_ws/calibration/handeye/aruco_handeye_samples.json \
  --out /home/rog/ros2_ws/calibration/handeye/aruco_handeye_result.json \
  --base-frame base_link \
  --camera-frame cam_overhead
```

输出文件：
- [aruco_handeye_result.json](/home/rog/ros2_ws/calibration/handeye/aruco_handeye_result.json)
...
**对应文档**
- 内参文档：[HX35HM_SO101_相机内参标定完整步骤.md](/home/rog/ros2_ws/docs/HX35HM_SO101_相机内参标定完整步骤.md)
- 红球抓取文档：[HX35HM_SO101_红球抓取完整执行步骤.md](/home/rog/ros2_ws/docs/HX35HM_SO101_红球抓取完整执行步骤.md)

如果你愿意，我下一步可以直接把这套内容继续并入当前这份：
- `标定完整流程.md`
